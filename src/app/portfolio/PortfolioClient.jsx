    ...
    <div className="bg-white min-h-screen font-sans overflow-x-hidden">
      ...
      <section className="relative w-full py-12 lg:py-20 overflow-hidden bg-gradient-to-r from-[#0f2a5f] via-[#13387a] to-[#0f2a5f]">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center text-white">
          ...
          <p className="text-gray-300 text-sm md:text-lg leading-relaxed max-w-3xl mx-auto mb-8">
      ...
      <section className="bg-white py-10 md:py-16 overflow-hidden font-sans">
        <div className="max-w-7xl mx-auto px-6">
          <div className="w-full mb-12 md:mb-16">
            <h2 className="text-[#2D2D2D] text-4xl md:text-4xl  font-semibold ">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="lg:w-1/2 space-y-2">
              ...
              <div className="pt-6 flex flex-wrap gap-4">
                <Link
                  href="/contact"
                  className="bg-[#49BCE3] hover:bg-[#3aa6cc] text-white px-10 py-3 rounded-2xl font-bold shadow-lg shadow-[#49BCE3]/20 cursor-pointer transition-all flex items-center gap-3 group text-lg active:scale-95"
                >
