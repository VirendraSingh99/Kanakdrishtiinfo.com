...
//           {/* Heading */}
//           <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-5xl font-extrabold leading-tight mb-4 sm:mb-6 tracking-tight">
...
//               <p className="text-[15px] sm:text-base md:text-lg leading-8 text-slate-700 text-justify">
...
//             <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[52px] font-bold text-slate-900 leading-tight tracking-tight">
//               Our Journey
//             </h2>
...
//                 The Beginning
//               </h3>
//               <p className="text-[15px] sm:text-base md:text-lg leading-8 md:leading-9 text-slate-700 text-justify">
...
//               <div
//                 key={index}
//                 className="bg-white p-8 rounded-xl border border-slate-200 shadow-sm transition-all hover:-translate-y-1"
//               >
...
//             {/* Paragraph Block 1 */}
//             <div className="space-y-6 text-[15px] sm:text-base md:text-lg leading-8 text-slate-700 text-justify">
//               <p>
...
//             {/* Sub Heading */}
//             <h3 className="text-2xl md:text-3xl font-bold text-slate-900 mt-14 mb-6">
...
//               <div
//                 key={index}
//                 className="p-6 border border-slate-800 rounded-lg bg-white hover:bg-white hover:text-black transition-colors group"
//               >
//                 <div className="mb-4 text-black group-hover:text-black">
//                   {industry.icon}
//                 </div>
//                 <h5 className="text-lg font-bold mb-2">{industry.title}</h5>
//                 <p className="text-sm text-black group-hover:text-slate-600">
//                   {industry.desc}
//                 </p>
//               </div>
//             ))}
...
//                   </h4>
//                 </div>
//                 <p className="text-lg text-slate-600 leading-relaxed pl-10">
...
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           {/* Padding ko p-8 se p-6 md:p-10 kar diya hai height kam karne ke liye */}
...
//               {/* Margin-bottom (mb) ko thoda kam kiya hai */}
...
//                 <Link
//                   href="/contact"
//                   className="w-full sm:w-auto px-8 py-3 bg-white text-black font-bold rounded-full hover:bg-slate-100 transition-colors text-base"
//                 >
//                   Contact Us Now
//                 </Link>
//                 <Link
//                   href="/services"
//                   className="w-full sm:w-auto px-8 py-3 border border-white text-white font-bold rounded-full hover:bg-white hover:text-black transition-all text-base"
//                 >
//                   Explore Services
//                 </Link>
//               </div>
...
export const metadata = {
  title: "About Us | Kanak Drishti Infotech – Digital Innovation & IT Solutions",
  description:
    "Kanak Drishti Infotech is a leading software development and digital marketing company. We deliver custom web, app, SEO, and branding solutions that drive measurable growth.",
  keywords:
    "about us, IT company India, software development company, digital marketing agency, web development, SEO company, app development, ERP CRM, branding agency",
  alternates: {
    canonical: "https://yourdomain.com/about",
  },
  openGraph: {
    title: "About Kanak Drishti Infotech – Driving Digital Excellence",
    description:
      "Learn how our decade of innovation, custom software development, and data-driven marketing strategies help businesses scale globally.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Kanak Drishti Infotech About Page",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "About Kanak Drishti Infotech – Digital Innovation & IT Solutions",
    description:
      "Trusted software development and digital marketing partner. Over 500+ projects delivered.",
...
// JSON-LD Schema (Organization + AboutPage)
const aboutSchema = {
  "@context": "https://schema.org",
  "@type": "AboutPage",
  name: "About Kanak Drishti Infotech",
  description:
    "Kanak Drishti Infotech is a leading software development and digital marketing company focused on transforming businesses into high-performance digital ecosystems.",
  url: "https://yourdomain.com/about",
  mainEntity: {
    "@type": "Organization",
